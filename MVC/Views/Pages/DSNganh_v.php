...
<body>
    <main class="table" id="students_table">
        <section class="table__header">
            ...
            <div class="Upload">
                <form action="<?php echo BASE_URL; ?>DSNganh/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="<?php echo BASE_URL; ?>DSNganh/exportExcel" method="post">
