    ...
    <main class="table" id="customers_table">
        <section class="table__header">
            ...
            <div class="input-group">
                <form action="' . BASE_URL . 'DSmonhoc/timkiem" method="post">        
            ...
            <div class="Insert">
                <form action="' . BASE_URL . 'monhoc" method="post">
                <button class="button-85" role="button">Thêm môn học</button>
                </form>
            </div>

            <div class="Upload">
                <form action="' . BASE_URL . 'DSmonhoc/uploadExcel" method="post" enctype="multipart/form-data">
            ...
            <div class="export__file">
                ...
                <div class="export__file-options">
                    ...
                    <form action="' . BASE_URL . 'DSmonhoc/exportExcel" method="post">
                        ...
                        if(isset($data['dulieu']) && mysqli_num_rows($data['dulieu'])>0) {
                            while($row = mysqli_fetch_assoc($data['dulieu'])) {
                                ...
                                <tr>
                                    ...
                                    <td class="btn_cn">
                                        <form action="' . BASE_URL . 'DSmonhoc/sua/<?php echo $row['ma_mon'] ?>" method="post">
                                            <button class="button-85" role="button">Sửa</button>
                                        </form>

                                        <form action="' . BASE_URL . 'DSmonhoc/xoa/<?php echo $row['ma_mon'] ?>" method="post">
